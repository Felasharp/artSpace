...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Ro(){return new Xn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:la(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Co(){return new Xn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:la(),fragmentShader:`
...
`].filter(pi).join(`
`)),a=jr(a),a=Bo(a,t),a=Ho(a,t),o=jr(o),o=Bo(o,t),o=Ho(o,t),a=zo(a),o=zo(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(v=`#version 300 es
